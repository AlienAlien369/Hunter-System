      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-3">
          <div className="min-w-0">
            <h1 className="text-2xl sm:text-3xl font-display text-gold mb-2 flex items-center">
          ...
          <div className="flex flex-wrap gap-3">
            {/* Streak Badge */}
            <div className="flex items-center space-x-2 bg-card/50 backdrop-blur-sm rounded-lg border border-purple-monarch/20 px-3 sm:px-4 py-2">
            ...
            {/* Progress Bar */}
            <div className="hidden sm:flex items-center space-x-2 bg-card/50 backdrop-blur-sm rounded-lg border border-purple-monarch/20 px-4 py-2 w-32">
