    ...
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center space-x-2.5 sm:space-x-4 flex-shrink-0">
              ...
              createPortal(
                <>
                  ...
                  <motion.div
                    ...
                    style={{
                      top: soundPosition.top,
                      right: soundPosition.right,
                    }}
                  >
                    <p className="text-[10px] text-gray-500 font-mono tracking-widest mb-2">
                      SOUND SETTINGS
                    </p>
                    ...
                    >
                      <span className="flex items-center space-x-2.5">
                        ...
                        <span className="text-left">
                          <span className="text-sm font-mono text-gray-300 block">
                            Milestone chime
                          </span>
                    ...
                    {/* Sound pack selector */}
                    <div
                      className={`px-3 py-2.5 rounded-lg ${muted ? "opacity-40" : ""}`}
                    >
          ...
          <div
            className="sm:hidden flex items-center justify-center w-8 h-8 rounded-full bg-green-500/10 border border-green-500/20"
            title="System online"
          >
            <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
          </div>
